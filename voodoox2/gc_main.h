/*
 $Id: gc_main.h,v 1.1 2004/01/20 06:24:59 stoecker Exp $
 Main definitions for GenClasses
...
#define TAG_BASE      (TAG_USER + 0x00430000) /* 0x8042xxxx range is reserved for MUI */
